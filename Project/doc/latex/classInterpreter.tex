...
}]TODO \index{THEIR\_\-TURN@{THEIR\_\-TURN}!Interpreter@{Interpreter}}\index{Interpreter@{Interpreter}!THEIR\_\-TURN@{THEIR\_\-TURN}}\item[{\em 
...
}]TODO \index{ATK@{ATK}!Interpreter@{Interpreter}}\index{Interpreter@{Interpreter}!ATK@{ATK}}\item[{\em 
...
}]TODO \index{DEF@{DEF}!Interpreter@{Interpreter}}\index{Interpreter@{Interpreter}!DEF@{DEF}}\item[{\em 
...
}]TODO \index{MIX@{MIX}!Interpreter@{Interpreter}}\index{Interpreter@{Interpreter}!MIX@{MIX}}\item[{\em 
...
\subsubsection[{showMap}]{\setlength{\rightskip}{0pt plus 5cm}void Interpreter::showMap (const {\bf Map} \& {\em map}, \/  string {\em path}, \/  {\bf Interpreter::Point} {\em start})\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
