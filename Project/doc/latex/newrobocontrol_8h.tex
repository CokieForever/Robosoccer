...
\begin{DoxyCompactList}\small\item\em Wrapper for the \char`\"{}RoboControl\char`\"{} class. Implements additional driving functions. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
